namespace _3_GUI.View
{
	partial class FrmNSX
	{
		...
		private void InitializeComponent()
		{
			...
			dgrid_NSX = new DataGridView();
			groupBox1.SuspendLayout();
			groupBox2.SuspendLayout();
			((System.ComponentModel.ISupportInitialize)dgrid_NSX).BeginInit();
			SuspendLayout();
			// 
			// groupBox1
			// 
			...
			groupBox1.Size = new Size(518, 232);
			...
			groupBox2.Size = new Size(246, 232);
			...
			// btn_Them
			// 
			btn_Them.Location = new Point(75, 46);
			...
			// txt_TimKiem
			// 
			txt_TimKiem.Location = new Point(12, 271);
			txt_TimKiem.Name = "txt_TimKiem";
			txt_TimKiem.Size = new Size(282, 27);
			...
			// dgrid_NSX
			// 
			dgrid_NSX.BackgroundColor = Color.SeaShell;
			dgrid_NSX.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
			dgrid_NSX.Location = new Point(12, 304);
			dgrid_NSX.Name = "dgrid_NSX";
			dgrid_NSX.RowHeadersWidth = 51;
			dgrid_NSX.RowTemplate.Height = 29;
			dgrid_NSX.Size = new Size(787, 155);
			dgrid_NSX.TabIndex = 8;
			dgrid_NSX.CellClick += dgrid_NSX_CellClick;
			// 
			// FrmNSX
			// 
			...
			((System.ComponentModel.ISupportInitialize)dgrid_NSX).EndInit();
			ResumeLayout(false);
			PerformLayout();
		}
