namespace _3_GUI.View
{
	partial class FrmNCC
	{
		...
		private void InitializeComponent()
		{
			...
			dgrid_NCC = new DataGridView();
			groupBox1.SuspendLayout();
			groupBox2.SuspendLayout();
			((System.ComponentModel.ISupportInitialize)dgrid_NCC).BeginInit();
			SuspendLayout();
			// 
			// groupBox1
			// 
			...
			groupBox1.Size = new Size(542, 232);
			...
			groupBox2.Size = new Size(289, 232);
			...
			// btn_Reset
			// 
			btn_Reset.Location = new Point(96, 184);
			...
			// btn_Xoa
			// 
			btn_Xoa.Location = new Point(96, 139);
			...
			txt_TimKiem.Size = new Size(325, 27);
			...
			// dgrid_NCC
			// 
			dgrid_NCC.BackgroundColor = Color.SeaShell;
			dgrid_NCC.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
			dgrid_NCC.Location = new Point(12, 283);
			dgrid_NCC.Name = "dgrid_NCC";
			dgrid_NCC.RowHeadersWidth = 51;
			dgrid_NCC.RowTemplate.Height = 29;
			dgrid_NCC.Size = new Size(830, 155);
			dgrid_NCC.TabIndex = 8;
			dgrid_NCC.CellContentClick += dgrid_NCC_CellContentClick;
			// 
			// FrmNCC
			// 
			...
			((System.ComponentModel.ISupportInitialize)dgrid_NCC).EndInit();
			ResumeLayout(false);
			PerformLayout();
		}
		...
		private DataGridView dgrid_NCC;
	}
}